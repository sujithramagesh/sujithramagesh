...
public class VectorMethods {
	static Vector<Student> studentList = new Vector<Student>(6);
	static Vector<Student> newList = new Vector<Student>();
	...
	/*
	 * public static int getVectorListCapacity() throws Exception{
	 * 
	 * //get the elementData field from VectorList class Field VectorField =
	 * VectorList.class.getDeclaredField("elementData");
	 * 
	 * 
	 ...
	 * 
	 * //now get the elementData Object Vector from our list Object[] internalVector
	 * = (Object[])VectorField.get(studentList);
	 * 
	 * //Internal Vector length is the VectorList capacity! return
	 * internalVector.length; }
	 */
	public static void comparetwoVectorList() {
		System.out.println("First VectorList is");
		showAllStudent(studentList);
		System.out.println("Second VectorList is");
		showAllStudent(newList);
		boolean flag = studentList.equals(newList);
		if (flag) {
			System.out.println("The VectorLists are equal");
		} else {
			System.out.println("The VectorLists are not equal");
		}

	}

	public static void copyingVector() {
	...
	public static void showAllStudent(Vector<Student> studentList) {
		System.out.println("ROLL_NO         NAME          AGE         ADDRESS       EMAIL_ID");
		for (Student s : studentList) {
			System.out.println(s.toString());
		}
